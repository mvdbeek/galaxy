...
describe("Invocations.vue with invocation", () => {
    ...
    it("renders one row", async () => {
        ...
        expect(columns.at(2).text()).toBe(moment.utc(mockInvocationData.create_time).fromNow());
        expect(columns.at(3).text()).toBe(moment.utc(mockInvocationData.update_time).fromNow());
