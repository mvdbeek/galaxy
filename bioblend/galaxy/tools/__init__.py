...
class ToolClient(Client):
    ...
    def install_dependencies(self, tool_id):
        ...
        This works for conda only currently.
        This functionality is available since galaxy release 16.10
        and is limited to admins.

        :type tool_id: str
        :param tool_id: id of the requested tool
        """
        url = "%s/tools/%s/install_dependencies" % (self.gi.url, tool_id)
        return Client._post(self, url=url, payload={})
