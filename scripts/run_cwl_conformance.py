...
def main(argv=None):
    arg_parser = argparse.ArgumentParser(
        description=DESCRIPTION, formatter_class=argparse.ArgumentDefaultsHelpFormatter, epilog=EPILOG_MSG
    )
    ...
    arg_parser.add_argument(
        "--test_path",
        default="test/api/test_cwl_conformance_v1_0.py:CwlConformanceTestCase.test_conformance_v1_0_17",
        help="Test path",
    )
