...
class DatasetCollectionManager:
    ...
    def get_converters_for_collection(self, trans, id: int, datatypes_registry: Registry, instance_type: str = "history"):
    ...
    def __load_element(self, trans, element_identifier, hide_source_items, copy_elements, history=None):
        ...
        if src_type == 'hda':
            ...
            element = self.__get_history_collection_instance(trans, decoded_id).collection
        # TODO: ldca.
        else:
