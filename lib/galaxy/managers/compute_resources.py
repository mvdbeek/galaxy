...
class ComputeResourceManager:
    ...
    def get_active_for(self, user: User | None) -> ComputeResource | None:
    ...
    def list_for(self, user: User | None) -> list[ComputeResource]:
        if user is None:
            return []
        stmt = (
            select(ComputeResource)
    ...
    def get_for_user(self, user: User | None, resource_id: int) -> ComputeResource | None:
    ...
    def _exchange_for_capabilities_token(self, resource: ComputeResource, user: User) -> str | None:
    ...
    def delete(self, user: User | None, resource_id: int) -> ComputeResource | None:
    ...
    def purge(self, user: User | None, resource_id: int) -> ComputeResource | None:
