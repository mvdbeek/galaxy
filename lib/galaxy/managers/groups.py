...
class GroupsManager:
    ...
    def update(self, trans: ProvidesAppContext, group_id: DecodedDatabaseIdField, group_model: GroupUpdateModel):
        """
        Modifies a group.
        """
        group = self._get_group(trans, group_id)
    ...
    def _get_group(self, trans: ProvidesAppContext, group_id: DecodedDatabaseIdField) -> model.Group:
