...
class ToolSourceBenchmarks:
    ...
    def benchmark_xml_parsing(self, iterations: int = 100) -> Optional[BenchmarkResult]:
    ...
    def benchmark_hash_computation(self, iterations: int = 1000) -> Optional[BenchmarkResult]:
