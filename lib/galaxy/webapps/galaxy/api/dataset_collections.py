...
class DatasetCollectionsController(
    ...
    @expose_api
    def update(self, trans: ProvidesHistoryContext, id, instance_type='history', attributes=None):
        """
        Iterate over all datasets of a collection and update all attributes listed in attributes.
        e.g attributes = {'dbkey': 'dm3', 'ext': 'txt'}
        ...
        * PUT /api/dataset_collections/{hdca_id}:
        ...
        self.hdca_manager.update_attributes(dataset_collection_instance, attributes=attributes)
