...
class VisualizationController(
    ...
    def copy(self, trans, id, **kwargs):
        visualization = self.get_visualization(
            trans, self.decode_id(id), check_ownership=False
        )
        user = trans.get_user()
    ...
    def rate_async(self, trans, id, rating):
        ...
        visualization = self.get_visualization(
            trans, self.decode_id(id), check_ownership=False, check_accessible=True
        )
    ...
    def _POST_to_saved(self, trans, id=None, revision=None, type=None, config=None, title=None, **kwargs):
        ...
        if id is not None:
            self.get_visualization(
                trans, self.decode_id(id), check_ownership=True, check_accessible=False
            )
