...
class HistoriesContentsService(ServiceBase):
    ...
    def index_jobs_summary(
        ...
        return [
            ...
            for job_state in fetch_job_states(trans.sa_session, ids, types)
        ]
    ...
    def get_dataset_collection_archive_for_download(
        self, trans, id: DecodedDatabaseIdField
    ):
        """
    ...
    def update_permissions(
        ...
        hda = self.hda_manager.get_owned(
            history_content_id, trans.user, current_history=trans.history, trans=trans
        )
    ...
    def __create_hda_from_ldda(
        self, trans, history: History, ldda_id: DecodedDatabaseIdField
    ):
    ...
    def __create_hda_from_copy(
        self, trans, history: History, original_hda_id: DecodedDatabaseIdField
    ):
