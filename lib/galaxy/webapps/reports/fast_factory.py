...
from galaxy.webapps.reports.buildapp import app_pair
...
def factory():
    ...
    gx_webapp, app = app_pair(global_conf=config.global_conf, load_app_kwds=config.load_app_kwds, wsgi_preflight=config.wsgi_preflight)
