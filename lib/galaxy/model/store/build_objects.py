...
Currently for each file correspond to a dataset and filename must be supplied.
...
no supported either. The format consumed by this script should continue to evolve to
