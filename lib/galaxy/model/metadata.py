    ...
    def wrap(self, value, session):
        ...
        if isinstance(value, int):
            ...
            if wrapped_value:
                ...
                # JobWrapper.finish() flushed a scratch dataset's Dataset.state = OK to the DB
                # before exec_after_process had removed the scratch file, exposing a globally
                # inconsistent state to the workflow scheduler.
                session.flush()
