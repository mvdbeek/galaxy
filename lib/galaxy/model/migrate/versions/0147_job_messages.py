...
job_job_stdout_column = Column("job_stdout", JSONType, nullable=True)
job_job_stderr_column = Column("job_stderr", JSONType, nullable=True)
task_job_stdout_column = Column("job_stdout", JSONType, nullable=True)
task_job_stderr_column = Column("job_stderr", JSONType, nullable=True)
