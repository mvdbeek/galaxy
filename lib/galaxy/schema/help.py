...
class HelpForumTopic(Model):
    ...
    tags_descriptions: Annotated[
        Optional[Any], Field(description="The descriptions of the tags of the topic.")
    ] = None
...
class HelpForumSearchResponse(Model):
    ...
    posts: Annotated[
        Optional[list[HelpForumPost]], Field(description="The list of posts returned by the search.")
    ] = None
    topics: Annotated[
        Optional[list[HelpForumTopic]], Field(description="The list of topics returned by the search.")
    ] = None
    users: Annotated[
        Optional[list[HelpForumUser]], Field(description="The list of users returned by the search.")
    ] = None
    ...
    tags: Annotated[
        Optional[list[HelpForumTag]], Field(description="The list of tags returned by the search.")
    ] = None
    groups: Annotated[
