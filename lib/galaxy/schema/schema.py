...
WorkflowIdField = Field(
    ..., title="Workflow ID", description="The encoded ID of a workflow."
)
JobIdField = Field(
    ...,
    title="Job ID",
...
class HDABetaResponse(
    HDADetailedResponse
):  # TODO: change HDABeta name to a more appropriate one.
...
class HistoryDetailedResponse(
    HistorySummaryResponse
):  # Equivalent to 'dev-detailed' view, which seems the default
...
class JobExportHistoryArchiveModel(Model):
    ...
    job_id: DecodedDatabaseIdField = JobIdField
    ready: bool = Field(
        ...,
        title="Ready",
...
class HDCABetaResponse(
    HDCADetailedResponse
):  # TODO: change HDCABeta name to a more appropriate one.
...
class StoredWorkflowDetailedResponse(StoredWorkflowSummaryResponse):
    annotation: Optional[
        str
    ] = AnnotationField  # Inconsistency? See comment on StoredWorkflowSummary.annotations
...
class RoleDefinitionModel(BaseModel):
    ...
    user_ids: Optional[List[DecodedDatabaseIdField]] = Field(
        title="User IDs", default=[]
    )
    group_ids: Optional[List[DecodedDatabaseIdField]] = Field(
        title="Group IDs", default=[]
    )
...
UserIdsField = Field(
    title="User IDs",
    description="List of User IDs that should be part of this Group",
    default=[],
)
RoleIdsField = Field(
    title="Role IDs",
    description="List of Role IDs that should be part of this Group",
    default=[],
)
...
AnyHDAResponse = Union[HDABetaResponse, HDADetailedResponse, HDASummaryResponse]
AnyHDCAResponse = Union[HDCABetaResponse, HDCADetailedResponse, HDCASummaryResponse]
