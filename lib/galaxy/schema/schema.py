...
WorkflowIdField = Field(
    ...,
    title="Workflow ID",
    description="The encoded ID of a workflow."
)
JobIdField = Field(
    ...,
    title="Job ID",
...
class HDABetaResponse(HDADetailedResponse):  # TODO: change HDABeta name to a more appropriate one.
...
AnyHistoryViewResponse = Union[
    HistoryBetaResponse, HistoryDetailedResponse, HistorySummaryResponse,
...
RoleIdList = Union[List[DecodedDatabaseIdField], DecodedDatabaseIdField]  # Should we support just List[DecodedDatabaseIdField] in the future?
