...
__all__ = ["AnonymousArrayItem81"]


@dataclass
class AnonymousArrayItem81:
    """
    ...
    Example:
        ...
        obj = structure_from_dict({"key": {"field": "value"}}, AnonymousArrayItem81)
...
# Register cattrs hooks for AnonymousArrayItem81
def _structure_anonymousarrayitem81(data: dict[str, Any], _: type[AnonymousArrayItem81]) -> AnonymousArrayItem81:
    """Structure hook for cattrs to handle AnonymousArrayItem81 deserialization with typed values."""
    if data is None:
        return AnonymousArrayItem81()
    if isinstance(data, AnonymousArrayItem81):
        return data
    ...
    return AnonymousArrayItem81(_data=structured_data)


def _unstructure_anonymousarrayitem81(instance: AnonymousArrayItem81) -> dict[str, Any]:
    """Unstructure hook for cattrs to handle AnonymousArrayItem81 serialization."""
...
converter.register_structure_hook(AnonymousArrayItem81, _structure_anonymousarrayitem81)
converter.register_unstructure_hook(AnonymousArrayItem81, _unstructure_anonymousarrayitem81)
