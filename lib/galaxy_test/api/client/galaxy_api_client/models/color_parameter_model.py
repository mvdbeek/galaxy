...
__all__ = ["ColorParameterModel"]


@dataclass
class ColorParameterModel:
    """
    ColorParameterModel dataclass
    ...
    Args:
        ...
        type_ (GalaxyToolParameterModelOutputTypeEnum)
                                 : Maps from 'type'
        argument (ColorParameterModelArgument | None)
    ...
    label: ColorParameterModelLabel | None = None  # Will be displayed on the tool page as the label of the parameter.
    optional: bool | None = False  # If `false`, parameter must have a value.
    parameter_type: str | None = "gx_color"
    value: ColorParameterModelValue | None = None
