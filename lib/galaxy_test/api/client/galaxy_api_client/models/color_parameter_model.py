...
T = TypeVar("T", bound="ColorParameterModel")
...
class ColorParameterModel:
    ...
    Attributes:
        ...
        parameter_type (Literal['gx_color'] | Unset):  Default: 'gx_color'.
    ...
    parameter_type: Literal["gx_color"] | Unset = "gx_color"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["color"], d.pop("type"))
        if type_ != "color":
            raise ValueError(f"type must match const 'color', got '{type_}'")
        ...
        parameter_type = cast(Literal["gx_color"] | Unset, d.pop("parameter_type", UNSET))
        if parameter_type != "gx_color" and not isinstance(parameter_type, Unset):
            raise ValueError(f"parameter_type must match const 'gx_color', got '{parameter_type}'")
        ...
        color_parameter_model.additional_properties = d
        return color_parameter_model
