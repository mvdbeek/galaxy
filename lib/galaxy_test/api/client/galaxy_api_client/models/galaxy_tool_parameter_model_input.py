...
__all__ = ["GalaxyToolParameterModelInput", "GalaxyToolParameterModelInputDiscriminator"]


@dataclass(frozen=True)
class GalaxyToolParameterModelInputDiscriminator:
    """Discriminator metadata for GalaxyToolParameterModelInput union."""
...
GalaxyToolParameterModelInput: TypeAlias = Annotated[
    Union[
        TextParameterModel,
    ...
    GalaxyToolParameterModelInputDiscriminator(),
]
