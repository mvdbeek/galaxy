...
T = TypeVar("T", bound="DataLandingRequestState")
...
class DataLandingRequestState:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        data_landing_request_state = cls(
            targets=targets,
        )

        data_landing_request_state.additional_properties = d
        return data_landing_request_state
