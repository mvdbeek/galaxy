...
__all__ = ["DatatypesEdamFormatsEdamFormats200Response"]


@dataclass
class DatatypesEdamFormatsEdamFormats200Response:
    """
    ...
    Example:
        ...
        obj = structure_from_dict({"key": {"field": "value"}}, DatatypesEdamFormatsEdamFormats200Response)
...
# Register cattrs hooks for DatatypesEdamFormatsEdamFormats200Response
def _structure_datatypesedamformatsedamformats200response(
    data: dict[str, Any], _: type[DatatypesEdamFormatsEdamFormats200Response]
) -> DatatypesEdamFormatsEdamFormats200Response:
    """Structure hook for cattrs to handle DatatypesEdamFormatsEdamFormats200Response deserialization with typed values."""
    if data is None:
        return DatatypesEdamFormatsEdamFormats200Response()
    if isinstance(data, DatatypesEdamFormatsEdamFormats200Response):
        return data
    ...
    return DatatypesEdamFormatsEdamFormats200Response(_data=structured_data)


def _unstructure_datatypesedamformatsedamformats200response(
    instance: DatatypesEdamFormatsEdamFormats200Response,
) -> dict[str, Any]:
    """Unstructure hook for cattrs to handle DatatypesEdamFormatsEdamFormats200Response serialization."""
...
converter.register_structure_hook(
    DatatypesEdamFormatsEdamFormats200Response, _structure_datatypesedamformatsedamformats200response
)
converter.register_unstructure_hook(
    DatatypesEdamFormatsEdamFormats200Response, _unstructure_datatypesedamformatsedamformats200response
)
