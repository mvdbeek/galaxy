...
if TYPE_CHECKING:
    from ..models.custom_history_view_contents_states_type_0 import CustomHistoryViewContentsStatesType0
    from ..models.custom_history_view_state_details_type_0 import CustomHistoryViewStateDetailsType0
    from ..models.custom_history_view_state_ids_type_0 import CustomHistoryViewStateIdsType0
    from ..models.history_active_content_counts import HistoryActiveContentCounts


T = TypeVar("T", bound="CustomHistoryView")
...
class CustomHistoryView:
    ...
    will be requested, so we have to allow all fields to be optional.
        ...
        Attributes:
            ...
            contents_active (HistoryActiveContentCounts | None | Unset): Contains the number of active, deleted or hidden
                items in a History.
            contents_states (CustomHistoryViewContentsStatesType0 | None | Unset): A dictionary keyed to possible dataset
                states and valued with the number of datasets in this history that have those states.
            ...
            state (DatasetState | None | Unset): The current state of the History based on the states of the datasets it
                contains.
            state_details (CustomHistoryViewStateDetailsType0 | None | Unset): A dictionary keyed to possible dataset states
                and valued with the number of datasets in this history that have those states.
            state_ids (CustomHistoryViewStateIdsType0 | None | Unset): A dictionary keyed to possible dataset states and
                valued with lists containing the ids of each HDA in that state.
    ...
    contents_states: CustomHistoryViewContentsStatesType0 | None | Unset = UNSET
    ...
    state_details: CustomHistoryViewStateDetailsType0 | None | Unset = UNSET
    state_ids: CustomHistoryViewStateIdsType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.contents_states, CustomHistoryViewContentsStatesType0):
        ...
        if isinstance(self.state_details, Unset):
            state_details = UNSET
        elif isinstance(self.state_details, CustomHistoryViewStateDetailsType0):
        ...
        if isinstance(self.state_ids, Unset):
            state_ids = UNSET
        elif isinstance(self.state_ids, CustomHistoryViewStateIdsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_contents_states(data: object) -> CustomHistoryViewContentsStatesType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                contents_states_type_0 = CustomHistoryViewContentsStatesType0.from_dict(data)

                return contents_states_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(CustomHistoryViewContentsStatesType0 | None | Unset, data)
        ...
        def _parse_state_details(data: object) -> CustomHistoryViewStateDetailsType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                state_details_type_0 = CustomHistoryViewStateDetailsType0.from_dict(data)

                return state_details_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(CustomHistoryViewStateDetailsType0 | None | Unset, data)

        state_details = _parse_state_details(d.pop("state_details", UNSET))

        def _parse_state_ids(data: object) -> CustomHistoryViewStateIdsType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                state_ids_type_0 = CustomHistoryViewStateIdsType0.from_dict(data)

                return state_ids_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(CustomHistoryViewStateIdsType0 | None | Unset, data)
        ...
        custom_history_view.additional_properties = d
        return custom_history_view
