...
__all__ = ["InvocationStepJobsResponseStepModelStates"]


@dataclass
class InvocationStepJobsResponseStepModelStates:
    """
    ...
    Example:
        ...
        obj = structure_from_dict({"key": {"field": "value"}}, InvocationStepJobsResponseStepModelStates)
...
# Register cattrs hooks for InvocationStepJobsResponseStepModelStates
def _structure_invocationstepjobsresponsestepmodelstates(
    data: dict[str, Any], _: type[InvocationStepJobsResponseStepModelStates]
) -> InvocationStepJobsResponseStepModelStates:
    """Structure hook for cattrs to handle InvocationStepJobsResponseStepModelStates deserialization with typed values."""
    if data is None:
        return InvocationStepJobsResponseStepModelStates()
    if isinstance(data, InvocationStepJobsResponseStepModelStates):
        return data
    ...
    return InvocationStepJobsResponseStepModelStates(_data=structured_data)


def _unstructure_invocationstepjobsresponsestepmodelstates(
    instance: InvocationStepJobsResponseStepModelStates,
) -> dict[str, Any]:
    """Unstructure hook for cattrs to handle InvocationStepJobsResponseStepModelStates serialization."""
...
converter.register_structure_hook(
    InvocationStepJobsResponseStepModelStates, _structure_invocationstepjobsresponsestepmodelstates
)
converter.register_unstructure_hook(
    InvocationStepJobsResponseStepModelStates, _unstructure_invocationstepjobsresponsestepmodelstates
)
