...
if TYPE_CHECKING:
    from ..models.admin_tool_source import AdminToolSource
    from ..models.user_tool_source import UserToolSource


T = TypeVar("T", bound="DynamicToolCreatePayload")
...
class DynamicToolCreatePayload:
    """
    Attributes:
        representation (AdminToolSource | UserToolSource):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.representation, UserToolSource):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_representation(data: object) -> AdminToolSource | UserToolSource:
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                representation_type_0 = UserToolSource.from_dict(data)

                return representation_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            if not isinstance(data, dict):
                raise TypeError()
            representation_type_1 = AdminToolSource.from_dict(data)

            return representation_type_1

        representation = _parse_representation(d.pop("representation"))
        ...
        dynamic_tool_create_payload = cls(
            representation=representation,
            active=active,
            hidden=hidden,
            src=src,
        ...
        dynamic_tool_create_payload.additional_properties = d
        return dynamic_tool_create_payload
