...
T = TypeVar("T", bound="DataColumnParameterModel")
...
class DataColumnParameterModel:
    ...
    Attributes:
        ...
        parameter_type (Literal['gx_data_column'] | Unset):  Default: 'gx_data_column'.
        value (int | list[int] | None | Unset):
    """
    ...
    parameter_type: Literal["gx_data_column"] | Unset = "gx_data_column"
    value: int | list[int] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["data_column"], d.pop("type"))
        if type_ != "data_column":
            raise ValueError(f"type must match const 'data_column', got '{type_}'")
        ...
        parameter_type = cast(Literal["gx_data_column"] | Unset, d.pop("parameter_type", UNSET))
        if parameter_type != "gx_data_column" and not isinstance(parameter_type, Unset):
            raise ValueError(f"parameter_type must match const 'gx_data_column', got '{parameter_type}'")

        def _parse_value(data: object) -> int | list[int] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(int | list[int] | None | Unset, data)

        value = _parse_value(d.pop("value", UNSET))

        data_column_parameter_model = cls(
            multiple=multiple,
            name=name,
            type_=type_,
            argument=argument,
        ...
        data_column_parameter_model.additional_properties = d
        return data_column_parameter_model
