...
T = TypeVar("T", bound="FileDataElement")
...
class FileDataElement:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        src = cast(Literal["files"], d.pop("src"))
        if src != "files":
            raise ValueError(f"src must match const 'files', got '{src}'")
