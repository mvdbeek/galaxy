...
T = TypeVar("T", bound="CreateLibraryPayload")
...
class CreateLibraryPayload:
    ...
    Attributes:
        ...
        synopsis (None | str | Unset): A short text describing the contents of the Library. Default: ''.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_library_payload = cls(
            name=name,
            description=description,
            synopsis=synopsis,
        )

        create_library_payload.additional_properties = d
        return create_library_payload
