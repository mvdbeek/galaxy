...
T = TypeVar("T", bound="CreateWorkbookForCollectionApi")
...
class CreateWorkbookForCollectionApi:
    ...
    Attributes:
        ...
        prefix_values (list[list[bool | float | int | None | str]] | None | Unset): An area to pre-populate URIs, etc...
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_workbook_for_collection_api = cls(
            column_definitions=column_definitions,
            prefix_values=prefix_values,
        )

        create_workbook_for_collection_api.additional_properties = d
        return create_workbook_for_collection_api
