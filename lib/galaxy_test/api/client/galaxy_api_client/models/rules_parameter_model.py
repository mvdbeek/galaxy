...
class RulesParameterModel:
    ...
    Args:
        ...
        type_ (GalaxyToolParameterModelOutputTypeEnum)
                                 : Maps from 'type'
        argument (RulesParameterModelArgument | None)
        ...
        help_ (Help12 | None)    : Short bit of text, rendered on the tool form just below
                                   the associated field to provide information about the
                                   field. (maps from 'help')
        hidden (bool | None)     :
        is_dynamic (bool | None) :
        label (RulesParameterModelLabel | None)
    ...
    label: RulesParameterModelLabel | None = None  # Will be displayed on the tool page as the label of the parameter.
