...
T = TypeVar("T", bound="CwlFileParameterModel")
...
class CwlFileParameterModel:
    ...
    Attributes:
        ...
        parameter_type (Literal['cwl_file'] | Unset):  Default: 'cwl_file'.
    """
    ...
    parameter_type: Literal["cwl_file"] | Unset = "cwl_file"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        parameter_type = cast(Literal["cwl_file"] | Unset, d.pop("parameter_type", UNSET))
        if parameter_type != "cwl_file" and not isinstance(parameter_type, Unset):
            raise ValueError(f"parameter_type must match const 'cwl_file', got '{parameter_type}'")

        cwl_file_parameter_model = cls(
            name=name,
            argument=argument,
            help_=help_,
            hidden=hidden,
        ...
        cwl_file_parameter_model.additional_properties = d
        return cwl_file_parameter_model
