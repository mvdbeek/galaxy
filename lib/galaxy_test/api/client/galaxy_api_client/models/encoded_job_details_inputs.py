...
__all__ = ["EncodedJobDetailsInputs"]


@dataclass
class EncodedJobDetailsInputs:
    """
    ...
    Example:
        ...
        obj = structure_from_dict({"key": {"field": "value"}}, EncodedJobDetailsInputs)
...
# Register cattrs hooks for EncodedJobDetailsInputs
def _structure_encodedjobdetailsinputs(
    data: dict[str, Any], _: type[EncodedJobDetailsInputs]
) -> EncodedJobDetailsInputs:
    """Structure hook for cattrs to handle EncodedJobDetailsInputs deserialization with typed values."""
    if data is None:
        return EncodedJobDetailsInputs()
    if isinstance(data, EncodedJobDetailsInputs):
        return data
    ...
    return EncodedJobDetailsInputs(_data=structured_data)


def _unstructure_encodedjobdetailsinputs(instance: EncodedJobDetailsInputs) -> dict[str, Any]:
    """Unstructure hook for cattrs to handle EncodedJobDetailsInputs serialization."""
...
converter.register_structure_hook(EncodedJobDetailsInputs, _structure_encodedjobdetailsinputs)
converter.register_unstructure_hook(EncodedJobDetailsInputs, _unstructure_encodedjobdetailsinputs)
