...
T = TypeVar("T", bound="DirectoryUriParameterModel")


@_attrs_define
class DirectoryUriParameterModel:
    """
    Attributes:
        name (str): Parameter name. Used when referencing parameter in workflows or inside command templating.
        type_ (Literal['directory']):
        ...
        parameter_type (Literal['gx_directory_uri'] | Unset):  Default: 'gx_directory_uri'.
    ...
    parameter_type: Literal["gx_directory_uri"] | Unset = "gx_directory_uri"
    validators: (
        list[
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["directory"], d.pop("type"))
        if type_ != "directory":
            raise ValueError(f"type must match const 'directory', got '{type_}'")
        ...
        parameter_type = cast(Literal["gx_directory_uri"] | Unset, d.pop("parameter_type", UNSET))
        if parameter_type != "gx_directory_uri" and not isinstance(parameter_type, Unset):
            raise ValueError(f"parameter_type must match const 'gx_directory_uri', got '{parameter_type}'")
        ...
        directory_uri_parameter_model = cls(
            name=name,
            type_=type_,
            argument=argument,
            help_=help_,
        ...
        directory_uri_parameter_model.additional_properties = d
        return directory_uri_parameter_model
