...
class BaseUrlParameterModel:
    ...
    Attributes:
        ...
        parameter_type (Literal['gx_baseurl'] | Unset):  Default: 'gx_baseurl'.
    """
    ...
    parameter_type: Literal["gx_baseurl"] | Unset = "gx_baseurl"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["baseurl"], d.pop("type"))
        if type_ != "baseurl":
            raise ValueError(f"type must match const 'baseurl', got '{type_}'")
        ...
        parameter_type = cast(Literal["gx_baseurl"] | Unset, d.pop("parameter_type", UNSET))
        if parameter_type != "gx_baseurl" and not isinstance(parameter_type, Unset):
            raise ValueError(f"parameter_type must match const 'gx_baseurl', got '{parameter_type}'")

        base_url_parameter_model = cls(
            name=name,
            type_=type_,
            argument=argument,
            help_=help_,
        ...
        base_url_parameter_model.additional_properties = d
        return base_url_parameter_model
