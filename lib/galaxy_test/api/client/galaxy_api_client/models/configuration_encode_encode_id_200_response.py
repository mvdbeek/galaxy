...
__all__ = ["ConfigurationEncodeEncodeId200Response"]


@dataclass
class ConfigurationEncodeEncodeId200Response:
    """
    ...
    Example:
        ...
        obj = structure_from_dict({"key": {"field": "value"}}, ConfigurationEncodeEncodeId200Response)
...
# Register cattrs hooks for ConfigurationEncodeEncodeId200Response
def _structure_configurationencodeencodeid200response(
    data: dict[str, Any], _: type[ConfigurationEncodeEncodeId200Response]
) -> ConfigurationEncodeEncodeId200Response:
    """Structure hook for cattrs to handle ConfigurationEncodeEncodeId200Response deserialization with typed values."""
    if data is None:
        return ConfigurationEncodeEncodeId200Response()
    if isinstance(data, ConfigurationEncodeEncodeId200Response):
        return data
    ...
    return ConfigurationEncodeEncodeId200Response(_data=structured_data)


def _unstructure_configurationencodeencodeid200response(
    instance: ConfigurationEncodeEncodeId200Response,
) -> dict[str, Any]:
    """Unstructure hook for cattrs to handle ConfigurationEncodeEncodeId200Response serialization."""
...
converter.register_structure_hook(
    ConfigurationEncodeEncodeId200Response, _structure_configurationencodeencodeid200response
)
converter.register_unstructure_hook(
    ConfigurationEncodeEncodeId200Response, _unstructure_configurationencodeencodeid200response
)
