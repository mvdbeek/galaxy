...
__all__ = ["ArchivedHistoryDetailedStateDetails"]


@dataclass
class ArchivedHistoryDetailedStateDetails:
    """
    ...
    Example:
        ...
        obj = structure_from_dict({"key": {"field": "value"}}, ArchivedHistoryDetailedStateDetails)
...
# Register cattrs hooks for ArchivedHistoryDetailedStateDetails
def _structure_archivedhistorydetailedstatedetails(
    data: dict[str, Any], _: type[ArchivedHistoryDetailedStateDetails]
) -> ArchivedHistoryDetailedStateDetails:
    """Structure hook for cattrs to handle ArchivedHistoryDetailedStateDetails deserialization with typed values."""
    if data is None:
        return ArchivedHistoryDetailedStateDetails()
    if isinstance(data, ArchivedHistoryDetailedStateDetails):
        return data
    ...
    return ArchivedHistoryDetailedStateDetails(_data=structured_data)


def _unstructure_archivedhistorydetailedstatedetails(instance: ArchivedHistoryDetailedStateDetails) -> dict[str, Any]:
    """Unstructure hook for cattrs to handle ArchivedHistoryDetailedStateDetails serialization."""
...
converter.register_structure_hook(ArchivedHistoryDetailedStateDetails, _structure_archivedhistorydetailedstatedetails)
converter.register_unstructure_hook(
    ArchivedHistoryDetailedStateDetails, _unstructure_archivedhistorydetailedstatedetails
)
