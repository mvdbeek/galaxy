...
__all__ = ["GalaxySchemaSchemaOrganization2"]


@dataclass
class GalaxySchemaSchemaOrganization2:
    """
    GalaxySchemaSchemaOrganization2 dataclass
    ...
    Args:
        ...
        email_ (Email6 | None)   : Maps from 'email'
    ...
    email_: Email6 | None = None  # Maps from 'email'
