...
T = TypeVar("T", bound="CwlDirectoryParameterModel")
...
class CwlDirectoryParameterModel:
    ...
    Attributes:
        ...
        parameter_type (Literal['cwl_directory'] | Unset):  Default: 'cwl_directory'.
    """
    ...
    parameter_type: Literal["cwl_directory"] | Unset = "cwl_directory"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        parameter_type = cast(Literal["cwl_directory"] | Unset, d.pop("parameter_type", UNSET))
        if parameter_type != "cwl_directory" and not isinstance(parameter_type, Unset):
            raise ValueError(f"parameter_type must match const 'cwl_directory', got '{parameter_type}'")

        cwl_directory_parameter_model = cls(
            name=name,
            argument=argument,
            help_=help_,
            hidden=hidden,
        ...
        cwl_directory_parameter_model.additional_properties = d
        return cwl_directory_parameter_model
