...
T = TypeVar("T", bound="LibraryFolderPermissionsPayload")
...
class LibraryFolderPermissionsPayload:
    """
    Attributes:
        action (LibraryFolderPermissionAction | None | Unset): Indicates what action should be performed on the library
            folder.
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.action, Unset):
            action = UNSET
        elif isinstance(self.action, LibraryFolderPermissionAction):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_action(data: object) -> LibraryFolderPermissionAction | None | Unset:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                action_type_0 = LibraryFolderPermissionAction(data)

                return action_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(LibraryFolderPermissionAction | None | Unset, data)
        ...
        library_folder_permissions_payload = cls(
            action=action,
            add_ids=add_ids,
        ...
        library_folder_permissions_payload.additional_properties = d
        return library_folder_permissions_payload
