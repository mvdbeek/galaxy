...
__all__ = ["InvocationStepJobsResponseCollectionJobsModelStates"]


@dataclass
class InvocationStepJobsResponseCollectionJobsModelStates:
    """
    ...
    Example:
        ...
        obj = structure_from_dict({"key": {"field": "value"}}, InvocationStepJobsResponseCollectionJobsModelStates)
...
# Register cattrs hooks for InvocationStepJobsResponseCollectionJobsModelStates
def _structure_invocationstepjobsresponsecollectionjobsmodelstates(
    data: dict[str, Any], _: type[InvocationStepJobsResponseCollectionJobsModelStates]
) -> InvocationStepJobsResponseCollectionJobsModelStates:
    """Structure hook for cattrs to handle InvocationStepJobsResponseCollectionJobsModelStates deserialization with typed values."""
    if data is None:
        return InvocationStepJobsResponseCollectionJobsModelStates()
    if isinstance(data, InvocationStepJobsResponseCollectionJobsModelStates):
        return data
    ...
    return InvocationStepJobsResponseCollectionJobsModelStates(_data=structured_data)


def _unstructure_invocationstepjobsresponsecollectionjobsmodelstates(
    instance: InvocationStepJobsResponseCollectionJobsModelStates,
) -> dict[str, Any]:
    """Unstructure hook for cattrs to handle InvocationStepJobsResponseCollectionJobsModelStates serialization."""
...
converter.register_structure_hook(
    InvocationStepJobsResponseCollectionJobsModelStates, _structure_invocationstepjobsresponsecollectionjobsmodelstates
)
converter.register_unstructure_hook(
    InvocationStepJobsResponseCollectionJobsModelStates,
    _unstructure_invocationstepjobsresponsecollectionjobsmodelstates,
)
