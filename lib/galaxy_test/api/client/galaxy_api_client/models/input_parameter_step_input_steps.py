...
__all__ = ["InputParameterStepInputSteps"]


@dataclass
class InputParameterStepInputSteps:
    """
    ...
    Example:
        ...
        obj = structure_from_dict({"key": {"field": "value"}}, InputParameterStepInputSteps)
...
# Register cattrs hooks for InputParameterStepInputSteps
def _structure_inputparameterstepinputsteps(
    data: dict[str, Any], _: type[InputParameterStepInputSteps]
) -> InputParameterStepInputSteps:
    """Structure hook for cattrs to handle InputParameterStepInputSteps deserialization with typed values."""
    if data is None:
        return InputParameterStepInputSteps()
    if isinstance(data, InputParameterStepInputSteps):
        return data
    ...
    return InputParameterStepInputSteps(_data=structured_data)


def _unstructure_inputparameterstepinputsteps(instance: InputParameterStepInputSteps) -> dict[str, Any]:
    """Unstructure hook for cattrs to handle InputParameterStepInputSteps serialization."""
...
converter.register_structure_hook(InputParameterStepInputSteps, _structure_inputparameterstepinputsteps)
converter.register_unstructure_hook(InputParameterStepInputSteps, _unstructure_inputparameterstepinputsteps)
