...
__all__ = ["InvocationJobsResponseStates"]


@dataclass
class InvocationJobsResponseStates:
    """
    ...
    Example:
        ...
        obj = structure_from_dict({"key": {"field": "value"}}, InvocationJobsResponseStates)
...
# Register cattrs hooks for InvocationJobsResponseStates
def _structure_invocationjobsresponsestates(
    data: dict[str, Any], _: type[InvocationJobsResponseStates]
) -> InvocationJobsResponseStates:
    """Structure hook for cattrs to handle InvocationJobsResponseStates deserialization with typed values."""
    if data is None:
        return InvocationJobsResponseStates()
    if isinstance(data, InvocationJobsResponseStates):
        return data
    ...
    return InvocationJobsResponseStates(_data=structured_data)


def _unstructure_invocationjobsresponsestates(instance: InvocationJobsResponseStates) -> dict[str, Any]:
    """Unstructure hook for cattrs to handle InvocationJobsResponseStates serialization."""
...
converter.register_structure_hook(InvocationJobsResponseStates, _structure_invocationjobsresponsestates)
converter.register_unstructure_hook(InvocationJobsResponseStates, _unstructure_invocationjobsresponsestates)
