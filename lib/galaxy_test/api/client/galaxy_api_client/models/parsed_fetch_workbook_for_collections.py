...
from ..models.parsed_fetch_workbook_for_collections_collection_type import (
    ParsedFetchWorkbookForCollectionsCollectionType,
)
from ..models.parsed_fetch_workbook_for_collections_workbook_type import ParsedFetchWorkbookForCollectionsWorkbookType
...
if TYPE_CHECKING:
    ...
    from ..models.parsed_fetch_workbook_for_collections_rows_item import ParsedFetchWorkbookForCollectionsRowsItem
    from ..models.split_up_paired_data_log_entry import SplitUpPairedDataLogEntry


T = TypeVar("T", bound="ParsedFetchWorkbookForCollections")
...
class ParsedFetchWorkbookForCollections:
    ...
    Attributes:
        ...
        rows (list[ParsedFetchWorkbookForCollectionsRowsItem]):
        workbook_type (ParsedFetchWorkbookForCollectionsWorkbookType | Unset):  Default:
            ParsedFetchWorkbookForCollectionsWorkbookType.COLLECTION.
    """
    ...
    rows: list[ParsedFetchWorkbookForCollectionsRowsItem]
    workbook_type: ParsedFetchWorkbookForCollectionsWorkbookType | Unset = (
        ParsedFetchWorkbookForCollectionsWorkbookType.COLLECTION
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        collection_type = ParsedFetchWorkbookForCollectionsCollectionType(d.pop("collection_type"))
        ...
        for rows_item_data in _rows:
            rows_item = ParsedFetchWorkbookForCollectionsRowsItem.from_dict(rows_item_data)
        ...
        if isinstance(_workbook_type, Unset):
            ...
            workbook_type = ParsedFetchWorkbookForCollectionsWorkbookType(_workbook_type)

        parsed_fetch_workbook_for_collections = cls(
            collection_type=collection_type,
            columns=columns,
            parse_log=parse_log,
            rows=rows,
        ...
        parsed_fetch_workbook_for_collections.additional_properties = d
        return parsed_fetch_workbook_for_collections
