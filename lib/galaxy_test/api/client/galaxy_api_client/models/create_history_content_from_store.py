...
if TYPE_CHECKING:
    from ..models.create_history_content_from_store_store_dict_type_0 import CreateHistoryContentFromStoreStoreDictType0


T = TypeVar("T", bound="CreateHistoryContentFromStore")
...
class CreateHistoryContentFromStore:
    ...
    Attributes:
        ...
        store_dict (CreateHistoryContentFromStoreStoreDictType0 | None | Unset):
    """

    model_store_format: ModelStoreFormat | None | Unset = UNSET
    store_content_uri: None | str | Unset = UNSET
    store_dict: CreateHistoryContentFromStoreStoreDictType0 | None | Unset = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        from ..models.create_history_content_from_store_store_dict_type_0 import (
        ...
        if isinstance(self.store_dict, Unset):
            store_dict = UNSET
        elif isinstance(self.store_dict, CreateHistoryContentFromStoreStoreDictType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_store_dict(data: object) -> CreateHistoryContentFromStoreStoreDictType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                store_dict_type_0 = CreateHistoryContentFromStoreStoreDictType0.from_dict(data)

                return store_dict_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(CreateHistoryContentFromStoreStoreDictType0 | None | Unset, data)

        store_dict = _parse_store_dict(d.pop("store_dict", UNSET))

        create_history_content_from_store = cls(
            model_store_format=model_store_format,
            store_content_uri=store_content_uri,
            store_dict=store_dict,
        )

        create_history_content_from_store.additional_properties = d
        return create_history_content_from_store
