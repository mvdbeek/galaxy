...
T = TypeVar("T", bound="HiddenParameterModel")
...
class HiddenParameterModel:
    ...
    Attributes:
        ...
        parameter_type (Literal['gx_hidden'] | Unset):  Default: 'gx_hidden'.
    ...
    parameter_type: Literal["gx_hidden"] | Unset = "gx_hidden"
    validators: (
        list[
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["hidden"], d.pop("type"))
        if type_ != "hidden":
            raise ValueError(f"type must match const 'hidden', got '{type_}'")
        ...
        parameter_type = cast(Literal["gx_hidden"] | Unset, d.pop("parameter_type", UNSET))
        if parameter_type != "gx_hidden" and not isinstance(parameter_type, Unset):
            raise ValueError(f"parameter_type must match const 'gx_hidden', got '{parameter_type}'")
        ...
        hidden_parameter_model.additional_properties = d
        return hidden_parameter_model
