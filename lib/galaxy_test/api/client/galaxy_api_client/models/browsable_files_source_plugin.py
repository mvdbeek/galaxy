...
T = TypeVar("T", bound="BrowsableFilesSourcePlugin")
...
class BrowsableFilesSourcePlugin:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        browsable_files_source_plugin = cls(
            browsable=browsable,
            id=id,
            label=label,
            type_=type_,
        ...
        browsable_files_source_plugin.additional_properties = d
        return browsable_files_source_plugin
