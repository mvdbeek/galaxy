...
T = TypeVar("T", bound="EncodedHistoryContentItem")
...
class EncodedHistoryContentItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        encoded_history_content_item = cls(
            history_content_type=history_content_type,
            id=id,
        )

        encoded_history_content_item.additional_properties = d
        return encoded_history_content_item
