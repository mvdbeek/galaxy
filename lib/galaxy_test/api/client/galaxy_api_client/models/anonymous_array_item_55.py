...
__all__ = ["AnonymousArrayItem55", "AnonymousArrayItem55Discriminator"]


@dataclass(frozen=True)
class AnonymousArrayItem55Discriminator:
    """Discriminator metadata for AnonymousArrayItem55 union."""
