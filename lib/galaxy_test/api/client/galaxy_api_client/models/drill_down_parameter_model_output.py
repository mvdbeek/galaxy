...
__all__ = ["DrillDownParameterModelOutput"]


@dataclass
class DrillDownParameterModelOutput:
    """
    DrillDownParameterModelOutput dataclass
    ...
    Args:
        ...
        help_ (Help28 | None)    : Short bit of text, rendered on the tool form just below
