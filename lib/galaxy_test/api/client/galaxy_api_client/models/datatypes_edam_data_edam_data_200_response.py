...
__all__ = ["DatatypesEdamDataEdamData200Response"]


@dataclass
class DatatypesEdamDataEdamData200Response:
    """
    ...
    Example:
        ...
        obj = structure_from_dict({"key": {"field": "value"}}, DatatypesEdamDataEdamData200Response)
...
# Register cattrs hooks for DatatypesEdamDataEdamData200Response
def _structure_datatypesedamdataedamdata200response(
    data: dict[str, Any], _: type[DatatypesEdamDataEdamData200Response]
) -> DatatypesEdamDataEdamData200Response:
    """Structure hook for cattrs to handle DatatypesEdamDataEdamData200Response deserialization with typed values."""
    if data is None:
        return DatatypesEdamDataEdamData200Response()
    if isinstance(data, DatatypesEdamDataEdamData200Response):
        return data
    ...
    return DatatypesEdamDataEdamData200Response(_data=structured_data)


def _unstructure_datatypesedamdataedamdata200response(instance: DatatypesEdamDataEdamData200Response) -> dict[str, Any]:
    """Unstructure hook for cattrs to handle DatatypesEdamDataEdamData200Response serialization."""
...
converter.register_structure_hook(DatatypesEdamDataEdamData200Response, _structure_datatypesedamdataedamdata200response)
converter.register_unstructure_hook(
    DatatypesEdamDataEdamData200Response, _unstructure_datatypesedamdataedamdata200response
)
