...
__all__ = ["SectionParameterModelInput3"]


@dataclass
class SectionParameterModelInput3:
    """
    SectionParameterModelInput3 dataclass
    ...
    Args:
        ...
        help_ (Help26 | None)    : Short bit of text, rendered on the tool form just below
