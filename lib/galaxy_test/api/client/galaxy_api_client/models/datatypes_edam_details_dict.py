...
__all__ = ["DatatypesEdamDetailsDict"]


@dataclass
class DatatypesEdamDetailsDict:
    """
    ...
    Example:
        ...
        obj = structure_from_dict({"key": {"field": "value"}}, DatatypesEdamDetailsDict)
...
# Register cattrs hooks for DatatypesEdamDetailsDict
def _structure_datatypesedamdetailsdict(
    data: dict[str, Any], _: type[DatatypesEdamDetailsDict]
) -> DatatypesEdamDetailsDict:
    """Structure hook for cattrs to handle DatatypesEdamDetailsDict deserialization with typed values."""
    if data is None:
        return DatatypesEdamDetailsDict()
    if isinstance(data, DatatypesEdamDetailsDict):
        return data
    ...
    return DatatypesEdamDetailsDict(_data=structured_data)


def _unstructure_datatypesedamdetailsdict(instance: DatatypesEdamDetailsDict) -> dict[str, Any]:
    """Unstructure hook for cattrs to handle DatatypesEdamDetailsDict serialization."""
...
converter.register_structure_hook(DatatypesEdamDetailsDict, _structure_datatypesedamdetailsdict)
converter.register_unstructure_hook(DatatypesEdamDetailsDict, _unstructure_datatypesedamdetailsdict)
