...
T = TypeVar("T", bound="IntegerParameterModel")
...
class IntegerParameterModel:
    ...
    Attributes:
        ...
        parameter_type (Literal['gx_integer'] | Unset):  Default: 'gx_integer'.
    ...
    parameter_type: Literal["gx_integer"] | Unset = "gx_integer"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        parameter_type = cast(Literal["gx_integer"] | Unset, d.pop("parameter_type", UNSET))
        if parameter_type != "gx_integer" and not isinstance(parameter_type, Unset):
            raise ValueError(f"parameter_type must match const 'gx_integer', got '{parameter_type}'")
        ...
        integer_parameter_model.additional_properties = d
        return integer_parameter_model
