...
from ..models.sample_sheet_column_definition_type import SampleSheetColumnDefinitionType
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.sample_sheet_column_definition_validators_type_0_item import (
        SampleSheetColumnDefinitionValidatorsType0Item,
    )


T = TypeVar("T", bound="SampleSheetColumnDefinition")
...
class SampleSheetColumnDefinition:
    ...
    Attributes:
        name (str):
        optional (bool):
        type_ (SampleSheetColumnDefinitionType):
        ...
        validators (list[SampleSheetColumnDefinitionValidatorsType0Item] | None | Unset):
    """
    ...
    validators: list[SampleSheetColumnDefinitionValidatorsType0Item] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = SampleSheetColumnDefinitionType(d.pop("type"))
        ...
        def _parse_validators(data: object) -> list[SampleSheetColumnDefinitionValidatorsType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for validators_type_0_item_data in _validators_type_0:
                    validators_type_0_item = SampleSheetColumnDefinitionValidatorsType0Item.from_dict(
                        validators_type_0_item_data
                    )
                ...
                pass
            return cast(list[SampleSheetColumnDefinitionValidatorsType0Item] | None | Unset, data)

        validators = _parse_validators(d.pop("validators", UNSET))

        sample_sheet_column_definition = cls(
            name=name,
            optional=optional,
            type_=type_,
        ...
        return sample_sheet_column_definition
