...
T = TypeVar("T", bound="GenomeBuildParameterModel")
...
class GenomeBuildParameterModel:
    ...
    Attributes:
        ...
        parameter_type (Literal['gx_genomebuild'] | Unset):  Default: 'gx_genomebuild'.
    """
    ...
    parameter_type: Literal["gx_genomebuild"] | Unset = "gx_genomebuild"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["genomebuild"], d.pop("type"))
        if type_ != "genomebuild":
            raise ValueError(f"type must match const 'genomebuild', got '{type_}'")
        ...
        parameter_type = cast(Literal["gx_genomebuild"] | Unset, d.pop("parameter_type", UNSET))
        if parameter_type != "gx_genomebuild" and not isinstance(parameter_type, Unset):
            raise ValueError(f"parameter_type must match const 'gx_genomebuild', got '{parameter_type}'")

        genome_build_parameter_model = cls(
            multiple=multiple,
            name=name,
            type_=type_,
            argument=argument,
        ...
        genome_build_parameter_model.additional_properties = d
        return genome_build_parameter_model
