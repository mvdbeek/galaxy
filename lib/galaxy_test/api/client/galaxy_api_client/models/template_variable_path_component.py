...
T = TypeVar("T", bound="TemplateVariablePathComponent")
...
class TemplateVariablePathComponent:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["path_component"], d.pop("type"))
        if type_ != "path_component":
            raise ValueError(f"type must match const 'path_component', got '{type_}'")
        ...
        template_variable_path_component = cls(
            help_=help_,
            name=name,
            type_=type_,
            default=default,
        ...
        return template_variable_path_component
