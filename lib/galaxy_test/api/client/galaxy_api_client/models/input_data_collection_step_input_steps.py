...
__all__ = ["InputDataCollectionStepInputSteps"]


@dataclass
class InputDataCollectionStepInputSteps:
    """
    ...
    Example:
        ...
        obj = structure_from_dict({"key": {"field": "value"}}, InputDataCollectionStepInputSteps)
...
# Register cattrs hooks for InputDataCollectionStepInputSteps
def _structure_inputdatacollectionstepinputsteps(
    data: dict[str, Any], _: type[InputDataCollectionStepInputSteps]
) -> InputDataCollectionStepInputSteps:
    """Structure hook for cattrs to handle InputDataCollectionStepInputSteps deserialization with typed values."""
    if data is None:
        return InputDataCollectionStepInputSteps()
    if isinstance(data, InputDataCollectionStepInputSteps):
        return data
    ...
    return InputDataCollectionStepInputSteps(_data=structured_data)


def _unstructure_inputdatacollectionstepinputsteps(instance: InputDataCollectionStepInputSteps) -> dict[str, Any]:
    """Unstructure hook for cattrs to handle InputDataCollectionStepInputSteps serialization."""
...
converter.register_structure_hook(InputDataCollectionStepInputSteps, _structure_inputdatacollectionstepinputsteps)
converter.register_unstructure_hook(InputDataCollectionStepInputSteps, _unstructure_inputdatacollectionstepinputsteps)
