...
T = TypeVar("T", bound="JobImportHistoryResponse")
...
class JobImportHistoryResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        job_import_history_response = cls(
            create_time=create_time,
            id=id,
            message=message,
            model_class=model_class,
        ...
        job_import_history_response.additional_properties = d
        return job_import_history_response
