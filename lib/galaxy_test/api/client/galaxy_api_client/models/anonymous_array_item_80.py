...
__all__ = ["AnonymousArrayItem80"]


@dataclass
class AnonymousArrayItem80:
    """
    ...
    Example:
        ...
        obj = structure_from_dict({"key": {"field": "value"}}, AnonymousArrayItem80)
...
# Register cattrs hooks for AnonymousArrayItem80
def _structure_anonymousarrayitem80(data: dict[str, Any], _: type[AnonymousArrayItem80]) -> AnonymousArrayItem80:
    """Structure hook for cattrs to handle AnonymousArrayItem80 deserialization with typed values."""
    if data is None:
        return AnonymousArrayItem80()
    if isinstance(data, AnonymousArrayItem80):
        return data
    ...
    return AnonymousArrayItem80(_data=structured_data)


def _unstructure_anonymousarrayitem80(instance: AnonymousArrayItem80) -> dict[str, Any]:
    """Unstructure hook for cattrs to handle AnonymousArrayItem80 serialization."""
...
converter.register_structure_hook(AnonymousArrayItem80, _structure_anonymousarrayitem80)
converter.register_unstructure_hook(AnonymousArrayItem80, _unstructure_anonymousarrayitem80)
