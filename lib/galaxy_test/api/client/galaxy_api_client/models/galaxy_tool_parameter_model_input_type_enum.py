...
__all__ = ["GalaxyToolParameterModelInputTypeEnum"]


@unique
class GalaxyToolParameterModelInputTypeEnum(str, Enum):
    """
    Discriminator enum for GalaxyToolParameterModelInput union types.
