...
__all__ = ["GroupTagParameterModel"]


@dataclass
class GroupTagParameterModel:
    """
    GroupTagParameterModel dataclass
    ...
    Args:
        ...
        type_ (GalaxyToolParameterModelOutputTypeEnum)
                                 : Maps from 'type'
        argument (GroupTagParameterModelArgument | None)
        ...
        help_ (Help14 | None)    : Short bit of text, rendered on the tool form just below
                                   the associated field to provide information about the
                                   field. (maps from 'help')
        hidden (bool | None)     :
        is_dynamic (bool | None) :
        label (GroupTagParameterModelLabel | None)
    ...
    parameter_type: str | None = "gx_group_tag"
