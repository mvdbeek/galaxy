...
__all__ = ["RootModelDictStrInt2"]


@dataclass
class RootModelDictStrInt2:
    """
    ...
    Example:
        ...
        obj = structure_from_dict({"key": {"field": "value"}}, RootModelDictStrInt2)
...
# Register cattrs hooks for RootModelDictStrInt2
def _structure_rootmodeldictstrint2(data: dict[str, Any], _: type[RootModelDictStrInt2]) -> RootModelDictStrInt2:
    """Structure hook for cattrs to handle RootModelDictStrInt2 deserialization with typed values."""
    if data is None:
        return RootModelDictStrInt2()
    if isinstance(data, RootModelDictStrInt2):
        return data
    ...
    return RootModelDictStrInt2(_data=structured_data)


def _unstructure_rootmodeldictstrint2(instance: RootModelDictStrInt2) -> dict[str, Any]:
    """Unstructure hook for cattrs to handle RootModelDictStrInt2 serialization."""
...
converter.register_structure_hook(RootModelDictStrInt2, _structure_rootmodeldictstrint2)
converter.register_unstructure_hook(RootModelDictStrInt2, _unstructure_rootmodeldictstrint2)
