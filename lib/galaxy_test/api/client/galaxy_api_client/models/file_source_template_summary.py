...
from ..models.file_source_template_summary_type import FileSourceTemplateSummaryType
...
T = TypeVar("T", bound="FileSourceTemplateSummary")
...
class FileSourceTemplateSummary:
    ...
    Attributes:
        ...
        id (str):
        name (None | str):
        type_ (FileSourceTemplateSummaryType):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = FileSourceTemplateSummaryType(d.pop("type"))
        ...
        file_source_template_summary = cls(
            description=description,
            id=id,
            name=name,
            type_=type_,
        ...
        return file_source_template_summary
