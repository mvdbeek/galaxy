...
if TYPE_CHECKING:
    ...
    from ..models.parsed_workbook_rows_item import ParsedWorkbookRowsItem


T = TypeVar("T", bound="ParsedWorkbook")
...
class ParsedWorkbook:
    ...
    Attributes:
        ...
        rows (list[ParsedWorkbookRowsItem]):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for rows_item_data in _rows:
            rows_item = ParsedWorkbookRowsItem.from_dict(rows_item_data)
        ...
        parsed_workbook.additional_properties = d
