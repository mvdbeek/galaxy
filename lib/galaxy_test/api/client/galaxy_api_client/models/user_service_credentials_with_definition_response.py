...
if TYPE_CHECKING:
    ...
    from ..models.service_credentials_definition import ServiceCredentialsDefinition


T = TypeVar("T", bound="UserServiceCredentialsWithDefinitionResponse")
...
class UserServiceCredentialsWithDefinitionResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        definition = ServiceCredentialsDefinition.from_dict(d.pop("definition"))
        ...
        user_service_credentials_with_definition_response = cls(
            definition=definition,
            groups=groups,
            id=id,
            name=name,
        ...
        user_service_credentials_with_definition_response.additional_properties = d
        return user_service_credentials_with_definition_response
