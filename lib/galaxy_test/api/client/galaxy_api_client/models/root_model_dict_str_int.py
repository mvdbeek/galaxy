...
__all__ = ["RootModelDictStrInt"]


@dataclass
class RootModelDictStrInt:
    """
    ...
    Example:
        ...
        obj = structure_from_dict({"key": {"field": "value"}}, RootModelDictStrInt)
...
# Register cattrs hooks for RootModelDictStrInt
def _structure_rootmodeldictstrint(data: dict[str, Any], _: type[RootModelDictStrInt]) -> RootModelDictStrInt:
    """Structure hook for cattrs to handle RootModelDictStrInt deserialization with typed values."""
    if data is None:
        return RootModelDictStrInt()
    if isinstance(data, RootModelDictStrInt):
        return data
    ...
    return RootModelDictStrInt(_data=structured_data)


def _unstructure_rootmodeldictstrint(instance: RootModelDictStrInt) -> dict[str, Any]:
    """Unstructure hook for cattrs to handle RootModelDictStrInt serialization."""
...
converter.register_structure_hook(RootModelDictStrInt, _structure_rootmodeldictstrint)
converter.register_unstructure_hook(RootModelDictStrInt, _unstructure_rootmodeldictstrint)
