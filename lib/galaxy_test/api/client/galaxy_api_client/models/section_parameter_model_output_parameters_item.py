...
from .conditional_parameter_model_output_3 import ConditionalParameterModelOutput3
...
__all__ = ["SectionParameterModelOutputParametersItem"]

SectionParameterModelOutputParametersItem: TypeAlias = (
    ...
    | ColorParameterModel
    | ConditionalParameterModelOutput3
