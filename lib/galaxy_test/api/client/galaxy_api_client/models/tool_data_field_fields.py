...
__all__ = ["ToolDataFieldFields"]


@dataclass
class ToolDataFieldFields:
    """
    ...
    Example:
        ...
        obj = structure_from_dict({"key": {"field": "value"}}, ToolDataFieldFields)
...
# Register cattrs hooks for ToolDataFieldFields
def _structure_tooldatafieldfields(data: dict[str, Any], _: type[ToolDataFieldFields]) -> ToolDataFieldFields:
    """Structure hook for cattrs to handle ToolDataFieldFields deserialization with typed values."""
    if data is None:
        return ToolDataFieldFields()
    if isinstance(data, ToolDataFieldFields):
        return data
    ...
    return ToolDataFieldFields(_data=structured_data)


def _unstructure_tooldatafieldfields(instance: ToolDataFieldFields) -> dict[str, Any]:
    """Unstructure hook for cattrs to handle ToolDataFieldFields serialization."""
...
converter.register_structure_hook(ToolDataFieldFields, _structure_tooldatafieldfields)
converter.register_unstructure_hook(ToolDataFieldFields, _unstructure_tooldatafieldfields)
