...
T = TypeVar("T", bound="SectionParameterModel")


@_attrs_define
class SectionParameterModel:
    """
    Attributes:
        ...
        parameter_type (Literal['gx_section'] | Unset):  Default: 'gx_section'.
    """
    ...
    parameter_type: Literal["gx_section"] | Unset = "gx_section"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["section"], d.pop("type"))
        if type_ != "section":
            raise ValueError(f"type must match const 'section', got '{type_}'")
        ...
        parameter_type = cast(Literal["gx_section"] | Unset, d.pop("parameter_type", UNSET))
        if parameter_type != "gx_section" and not isinstance(parameter_type, Unset):
            raise ValueError(f"parameter_type must match const 'gx_section', got '{parameter_type}'")

        section_parameter_model = cls(
            name=name,
            parameters=parameters,
            type_=type_,
            argument=argument,
        ...
        section_parameter_model.additional_properties = d
        return section_parameter_model
