...
if TYPE_CHECKING:
    from ..models.share_with_extra import ShareWithExtra
    from ..models.user_email import UserEmail


T = TypeVar("T", bound="ShareWithStatus")
...
class ShareWithStatus:
    ...
    Attributes:
        ...
        extra (None | ShareWithExtra | Unset): Optional extra information about this shareable resource that may be of
            interest. The contents of this field depend on the particular resource.
    ...
    extra: None | ShareWithExtra | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.extra, Unset):
            extra = UNSET
        elif isinstance(self.extra, ShareWithExtra):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_extra(data: object) -> None | ShareWithExtra | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                extra_type_0 = ShareWithExtra.from_dict(data)

                return extra_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | ShareWithExtra | Unset, data)
        ...
        share_with_status.additional_properties = d
        return share_with_status
