...
__all__ = ["GalaxyToolParameterModelOutput2", "GalaxyToolParameterModelOutput2Discriminator"]


@dataclass(frozen=True)
class GalaxyToolParameterModelOutput2Discriminator:
    """Discriminator metadata for GalaxyToolParameterModelOutput2 union."""
...
GalaxyToolParameterModelOutput2: TypeAlias = Annotated[
    Union[
        TextParameterModel,
    ...
    GalaxyToolParameterModelOutput2Discriminator(),
]
