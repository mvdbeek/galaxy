...
from ..models.create_history_content_payload_instance_type_type_0 import CreateHistoryContentPayloadInstanceTypeType0
from ..models.history_content_source import HistoryContentSource
...
if TYPE_CHECKING:
    ...
    from ..models.create_history_content_payload_rows_type_0 import CreateHistoryContentPayloadRowsType0
    from ..models.field_dict import FieldDict
    from ..models.sample_sheet_column_definition import SampleSheetColumnDefinition


T = TypeVar("T", bound="CreateHistoryContentPayload")
...
class CreateHistoryContentPayload:
    ...
    Attributes:
        ...
        content (None | str | Unset): Depending on the `source` it can be:
        ...
        copy_elements (bool | None | Unset): If the source is a collection, whether to copy child HDAs into the target
            history as well. Prior to the galaxy release 23.1 this defaulted to false. Default: True.
        dbkey (None | str | Unset): TODO
        ...
        instance_type (CreateHistoryContentPayloadInstanceTypeType0 | None | Unset): The type of the instance, either
            `history` (default) or `library`. Default: CreateHistoryContentPayloadInstanceTypeType0.HISTORY.
        name (None | str | Unset): The name of the new collection.
        rows (CreateHistoryContentPayloadRowsType0 | None | Unset): Specify rows of metadata data corresponding to an
            identifier if collection_type is sample_sheet
        source (HistoryContentSource | None | Unset): The source of the content. Can be other history element to be
            copied or library elements.
        type_ (HistoryContentType | None | Unset): The type of content to be created in the history. Default:
    ...
    instance_type: CreateHistoryContentPayloadInstanceTypeType0 | None | Unset = (
        CreateHistoryContentPayloadInstanceTypeType0.HISTORY
    )
    name: None | str | Unset = UNSET
    rows: CreateHistoryContentPayloadRowsType0 | None | Unset = UNSET
    source: HistoryContentSource | None | Unset = UNSET
    type_: HistoryContentType | None | Unset = HistoryContentType.DATASET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.instance_type, Unset):
            instance_type = UNSET
        elif isinstance(self.instance_type, CreateHistoryContentPayloadInstanceTypeType0):
        ...
        if isinstance(self.rows, Unset):
            rows = UNSET
        elif isinstance(self.rows, CreateHistoryContentPayloadRowsType0):
        ...
        if isinstance(self.source, Unset):
            source = UNSET
        elif isinstance(self.source, HistoryContentSource):
        ...
        if isinstance(self.type_, Unset):
            type_ = UNSET
        elif isinstance(self.type_, HistoryContentType):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_instance_type(data: object) -> CreateHistoryContentPayloadInstanceTypeType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                instance_type_type_0 = CreateHistoryContentPayloadInstanceTypeType0(data)

                return instance_type_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(CreateHistoryContentPayloadInstanceTypeType0 | None | Unset, data)
        ...
        def _parse_rows(data: object) -> CreateHistoryContentPayloadRowsType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                rows_type_0 = CreateHistoryContentPayloadRowsType0.from_dict(data)

                return rows_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(CreateHistoryContentPayloadRowsType0 | None | Unset, data)

        rows = _parse_rows(d.pop("rows", UNSET))

        def _parse_source(data: object) -> HistoryContentSource | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                source_type_0 = HistoryContentSource(data)

                return source_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(HistoryContentSource | None | Unset, data)

        source = _parse_source(d.pop("source", UNSET))

        def _parse_type_(data: object) -> HistoryContentType | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                type_type_0 = HistoryContentType(data)

                return type_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(HistoryContentType | None | Unset, data)

        type_ = _parse_type_(d.pop("type", UNSET))

        create_history_content_payload = cls(
        ...
        create_history_content_payload.additional_properties = d
        return create_history_content_payload
