...
T = TypeVar("T", bound="ServerDirElement")
...
class ServerDirElement:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        server_dir = d.pop("server_dir")

        src = cast(Literal["server_dir"], d.pop("src"))
        if src != "server_dir":
            raise ValueError(f"src must match const 'server_dir', got '{src}'")
