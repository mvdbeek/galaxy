...
__all__ = ["ChatHistoryClearChatHistory200Response"]


@dataclass
class ChatHistoryClearChatHistory200Response:
    """
    ...
    Example:
        ...
        obj = structure_from_dict({"key": {"field": "value"}}, ChatHistoryClearChatHistory200Response)
...
# Register cattrs hooks for ChatHistoryClearChatHistory200Response
def _structure_chathistoryclearchathistory200response(
    data: dict[str, Any], _: type[ChatHistoryClearChatHistory200Response]
) -> ChatHistoryClearChatHistory200Response:
    """Structure hook for cattrs to handle ChatHistoryClearChatHistory200Response deserialization with typed values."""
    if data is None:
        return ChatHistoryClearChatHistory200Response()
    if isinstance(data, ChatHistoryClearChatHistory200Response):
        return data
    ...
    return ChatHistoryClearChatHistory200Response(_data=structured_data)


def _unstructure_chathistoryclearchathistory200response(
    instance: ChatHistoryClearChatHistory200Response,
) -> dict[str, Any]:
    """Unstructure hook for cattrs to handle ChatHistoryClearChatHistory200Response serialization."""
...
converter.register_structure_hook(
    ChatHistoryClearChatHistory200Response, _structure_chathistoryclearchathistory200response
)
converter.register_unstructure_hook(
    ChatHistoryClearChatHistory200Response, _unstructure_chathistoryclearchathistory200response
)
