...
class ConvertedDatasetsMap:
    ...
    Example:
        ...
        obj = structure_from_dict({"key": {"field": "value"}}, ConvertedDatasetsMap)
...
# Register cattrs hooks for ConvertedDatasetsMap
def _structure_converteddatasetsmap(data: dict[str, Any], _: type[ConvertedDatasetsMap]) -> ConvertedDatasetsMap:
    """Structure hook for cattrs to handle ConvertedDatasetsMap deserialization with typed values."""
    if data is None:
        return ConvertedDatasetsMap()
    if isinstance(data, ConvertedDatasetsMap):
        return data
    ...
    return ConvertedDatasetsMap(_data=structured_data)


def _unstructure_converteddatasetsmap(instance: ConvertedDatasetsMap) -> dict[str, Any]:
    """Unstructure hook for cattrs to handle ConvertedDatasetsMap serialization."""
...
converter.register_structure_hook(ConvertedDatasetsMap, _structure_converteddatasetsmap)
converter.register_unstructure_hook(ConvertedDatasetsMap, _unstructure_converteddatasetsmap)
