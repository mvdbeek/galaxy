...
T = TypeVar("T", bound="UpdateStepLabelAction")
...
class UpdateStepLabelAction:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        action_type = cast(Literal["update_step_label"], d.pop("action_type"))
        if action_type != "update_step_label":
            raise ValueError(f"action_type must match const 'update_step_label', got '{action_type}'")
        ...
        update_step_label_action = cls(
            action_type=action_type,
            label=label,
            step=step,
        )

        update_step_label_action.additional_properties = d
        return update_step_label_action
