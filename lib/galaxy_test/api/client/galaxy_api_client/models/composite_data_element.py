...
if TYPE_CHECKING:
    from ..models.composite_data_element_metadata_type_0 import CompositeDataElementMetadataType0
    from ..models.composite_items import CompositeItems
...
class CompositeDataElement:
    ...
    Attributes:
        ...
        metadata (CompositeDataElementMetadataType0 | None | Unset):
    ...
    metadata: CompositeDataElementMetadataType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.metadata, Unset):
            metadata = UNSET
        elif isinstance(self.metadata, CompositeDataElementMetadataType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        composite = CompositeItems.from_dict(d.pop("composite"))

        src = cast(Literal["composite"], d.pop("src"))
        if src != "composite":
            raise ValueError(f"src must match const 'composite', got '{src}'")
        ...
        def _parse_metadata(data: object) -> CompositeDataElementMetadataType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                metadata_type_0 = CompositeDataElementMetadataType0.from_dict(data)

                return metadata_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(CompositeDataElementMetadataType0 | None | Unset, data)
