...
__all__ = ["InputDataStepInputSteps"]


@dataclass
class InputDataStepInputSteps:
    """
    ...
    Example:
        ...
        obj = structure_from_dict({"key": {"field": "value"}}, InputDataStepInputSteps)
...
# Register cattrs hooks for InputDataStepInputSteps
def _structure_inputdatastepinputsteps(
    data: dict[str, Any], _: type[InputDataStepInputSteps]
) -> InputDataStepInputSteps:
    """Structure hook for cattrs to handle InputDataStepInputSteps deserialization with typed values."""
    if data is None:
        return InputDataStepInputSteps()
    if isinstance(data, InputDataStepInputSteps):
        return data
    ...
    return InputDataStepInputSteps(_data=structured_data)


def _unstructure_inputdatastepinputsteps(instance: InputDataStepInputSteps) -> dict[str, Any]:
    """Unstructure hook for cattrs to handle InputDataStepInputSteps serialization."""
...
converter.register_structure_hook(InputDataStepInputSteps, _structure_inputdatastepinputsteps)
converter.register_unstructure_hook(InputDataStepInputSteps, _unstructure_inputdatastepinputsteps)
