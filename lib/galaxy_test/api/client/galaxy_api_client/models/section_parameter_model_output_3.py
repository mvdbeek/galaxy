...
__all__ = ["SectionParameterModelOutput3"]


@dataclass
class SectionParameterModelOutput3:
    """
    SectionParameterModelOutput3 dataclass
    ...
    Args:
        ...
        help_ (Help34 | None)    : Short bit of text, rendered on the tool form just below
