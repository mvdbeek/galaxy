...
T = TypeVar("T", bound="UpdateDatasetPermissionsPayloadAliasC")
...
class UpdateDatasetPermissionsPayloadAliasC:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_dataset_permissions_payload_alias_c = cls(
        ...
        update_dataset_permissions_payload_alias_c.additional_properties = d
        return update_dataset_permissions_payload_alias_c
