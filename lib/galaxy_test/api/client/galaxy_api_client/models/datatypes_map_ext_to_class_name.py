...
__all__ = ["DatatypesMapExtToClassName"]


@dataclass
class DatatypesMapExtToClassName:
    """
    ...
    Example:
        ...
        obj = structure_from_dict({"key": {"field": "value"}}, DatatypesMapExtToClassName)
...
# Register cattrs hooks for DatatypesMapExtToClassName
def _structure_datatypesmapexttoclassname(
    data: dict[str, Any], _: type[DatatypesMapExtToClassName]
) -> DatatypesMapExtToClassName:
    """Structure hook for cattrs to handle DatatypesMapExtToClassName deserialization with typed values."""
    if data is None:
        return DatatypesMapExtToClassName()
    if isinstance(data, DatatypesMapExtToClassName):
        return data
    ...
    return DatatypesMapExtToClassName(_data=structured_data)


def _unstructure_datatypesmapexttoclassname(instance: DatatypesMapExtToClassName) -> dict[str, Any]:
    """Unstructure hook for cattrs to handle DatatypesMapExtToClassName serialization."""
...
converter.register_structure_hook(DatatypesMapExtToClassName, _structure_datatypesmapexttoclassname)
converter.register_unstructure_hook(DatatypesMapExtToClassName, _unstructure_datatypesmapexttoclassname)
