...
__all__ = ["ImplicitCollectionJobsStateSummaryStates"]


@dataclass
class ImplicitCollectionJobsStateSummaryStates:
    """
    ...
    Example:
        ...
        obj = structure_from_dict({"key": {"field": "value"}}, ImplicitCollectionJobsStateSummaryStates)
...
# Register cattrs hooks for ImplicitCollectionJobsStateSummaryStates
def _structure_implicitcollectionjobsstatesummarystates(
    data: dict[str, Any], _: type[ImplicitCollectionJobsStateSummaryStates]
) -> ImplicitCollectionJobsStateSummaryStates:
    """Structure hook for cattrs to handle ImplicitCollectionJobsStateSummaryStates deserialization with typed values."""
    if data is None:
        return ImplicitCollectionJobsStateSummaryStates()
    if isinstance(data, ImplicitCollectionJobsStateSummaryStates):
        return data
    ...
    return ImplicitCollectionJobsStateSummaryStates(_data=structured_data)


def _unstructure_implicitcollectionjobsstatesummarystates(
    instance: ImplicitCollectionJobsStateSummaryStates,
) -> dict[str, Any]:
    """Unstructure hook for cattrs to handle ImplicitCollectionJobsStateSummaryStates serialization."""
...
converter.register_structure_hook(
    ImplicitCollectionJobsStateSummaryStates, _structure_implicitcollectionjobsstatesummarystates
)
converter.register_unstructure_hook(
    ImplicitCollectionJobsStateSummaryStates, _unstructure_implicitcollectionjobsstatesummarystates
)
