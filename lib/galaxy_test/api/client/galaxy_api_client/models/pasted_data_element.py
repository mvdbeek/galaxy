...
T = TypeVar("T", bound="PastedDataElement")
...
class PastedDataElement:
    """
    Attributes:
        paste_content (bool | float | int | str): This is the text of the content to import if the 'src' of the item is
            'pasted'.
        src (Literal['pasted']):
    ...
    paste_content: bool | float | int | str
    src: Literal["pasted"]
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        paste_content: bool | float | int | str
        paste_content = self.paste_content
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_paste_content(data: object) -> bool | float | int | str:
            return cast(bool | float | int | str, data)

        paste_content = _parse_paste_content(d.pop("paste_content"))

        src = cast(Literal["pasted"], d.pop("src"))
        if src != "pasted":
            raise ValueError(f"src must match const 'pasted', got '{src}'")
