...
T = TypeVar("T", bound="UrlDataElement")
...
class UrlDataElement:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        src = cast(Literal["url"], d.pop("src"))
        if src != "url":
            raise ValueError(f"src must match const 'url', got '{src}'")
