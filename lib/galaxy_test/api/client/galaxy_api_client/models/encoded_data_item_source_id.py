...
T = TypeVar("T", bound="EncodedDataItemSourceId")
...
class EncodedDataItemSourceId:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        encoded_data_item_source_id = cls(
            id=id,
            src=src,
        )

        encoded_data_item_source_id.additional_properties = d
        return encoded_data_item_source_id
