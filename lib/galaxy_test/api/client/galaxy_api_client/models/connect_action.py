...
T = TypeVar("T", bound="ConnectAction")
...
class ConnectAction:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        action_type = cast(Literal["connect"], d.pop("action_type"))
        if action_type != "connect":
            raise ValueError(f"action_type must match const 'connect', got '{action_type}'")
        ...
        connect_action.additional_properties = d
