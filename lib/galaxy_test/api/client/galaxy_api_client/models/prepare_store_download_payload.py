...
if TYPE_CHECKING:
    from ..models.prepare_store_download_payload_bco_override_algorithmic_error_type_0 import (
        PrepareStoreDownloadPayloadBcoOverrideAlgorithmicErrorType0,
    )
    from ..models.prepare_store_download_payload_bco_override_empirical_error_type_0 import (
        PrepareStoreDownloadPayloadBcoOverrideEmpiricalErrorType0,
    )
    from ..models.prepare_store_download_payload_bco_override_environment_variables_type_0 import (
        PrepareStoreDownloadPayloadBcoOverrideEnvironmentVariablesType0,
    )
    from ..models.xref_item import XrefItem


T = TypeVar("T", bound="PrepareStoreDownloadPayload")
...
class PrepareStoreDownloadPayload:
    ...
    Attributes:
        ...
        bco_override_algorithmic_error (None | PrepareStoreDownloadPayloadBcoOverrideAlgorithmicErrorType0 | Unset):
            Override algorithmic error for 'error domain' when generating BioCompute object.
        bco_override_empirical_error (None | PrepareStoreDownloadPayloadBcoOverrideEmpiricalErrorType0 | Unset):
            Override empirical error for 'error domain' when generating BioCompute object.
        bco_override_environment_variables (None | PrepareStoreDownloadPayloadBcoOverrideEnvironmentVariablesType0 |
            Unset): Override environment variables for 'execution_domain' when generating BioCompute object.
    ...
    bco_override_algorithmic_error: None | PrepareStoreDownloadPayloadBcoOverrideAlgorithmicErrorType0 | Unset = UNSET
    bco_override_empirical_error: None | PrepareStoreDownloadPayloadBcoOverrideEmpiricalErrorType0 | Unset = UNSET
    bco_override_environment_variables: (
        None | PrepareStoreDownloadPayloadBcoOverrideEnvironmentVariablesType0 | Unset
    ) = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.bco_override_algorithmic_error, Unset):
            ...
            self.bco_override_algorithmic_error, PrepareStoreDownloadPayloadBcoOverrideAlgorithmicErrorType0
        ):
        ...
        elif isinstance(self.bco_override_empirical_error, PrepareStoreDownloadPayloadBcoOverrideEmpiricalErrorType0):
        ...
        if isinstance(self.bco_override_environment_variables, Unset):
            ...
            self.bco_override_environment_variables, PrepareStoreDownloadPayloadBcoOverrideEnvironmentVariablesType0
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_bco_override_algorithmic_error(
            data: object,
        ) -> None | PrepareStoreDownloadPayloadBcoOverrideAlgorithmicErrorType0 | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                bco_override_algorithmic_error_type_0 = (
                    PrepareStoreDownloadPayloadBcoOverrideAlgorithmicErrorType0.from_dict(data)
                )

                return bco_override_algorithmic_error_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PrepareStoreDownloadPayloadBcoOverrideAlgorithmicErrorType0 | Unset, data)
        ...
        def _parse_bco_override_empirical_error(
            data: object,
        ) -> None | PrepareStoreDownloadPayloadBcoOverrideEmpiricalErrorType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                bco_override_empirical_error_type_0 = (
                    PrepareStoreDownloadPayloadBcoOverrideEmpiricalErrorType0.from_dict(data)
                )

                return bco_override_empirical_error_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PrepareStoreDownloadPayloadBcoOverrideEmpiricalErrorType0 | Unset, data)
        ...
        def _parse_bco_override_environment_variables(
            ...
            try:
                ...
                bco_override_environment_variables_type_0 = (
                    PrepareStoreDownloadPayloadBcoOverrideEnvironmentVariablesType0.from_dict(data)
                )

                return bco_override_environment_variables_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PrepareStoreDownloadPayloadBcoOverrideEnvironmentVariablesType0 | Unset, data)
        ...
        prepare_store_download_payload = cls(
        ...
        prepare_store_download_payload.additional_properties = d
        return prepare_store_download_payload
