...
from ...models.datatype_details import DatatypeDetails
...
) -> MessageExceptionModel | list[DatatypeDetails] | list[str] | None:
    if response.status_code == 200:

        def _parse_response_200(data: object) -> list[DatatypeDetails] | list[str]:
            try:
                ...
                for response_200_type_0_item_data in _response_200_type_0:
                    response_200_type_0_item = DatatypeDetails.from_dict(response_200_type_0_item_data)
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[MessageExceptionModel | list[DatatypeDetails] | list[str]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        MessageExceptionModel | list[DatatypeDetails] | list[str]
    """
