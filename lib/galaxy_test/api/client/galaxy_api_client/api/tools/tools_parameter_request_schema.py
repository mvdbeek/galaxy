...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/tools/{tool_id}/parameter_request_schema".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Return a JSON schema description of the tool's inputs for the tool request API that will be added to
    Galaxy at some point

     The tool request schema includes validation of map/reduce concepts that can be consumed by the tool
    execution API and not just the request for a single execution.
