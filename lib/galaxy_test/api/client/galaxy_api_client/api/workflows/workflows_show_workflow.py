...
def _get_kwargs(
    ...
    *,
    ...
    json_legacy: bool | None | Unset
    if isinstance(legacy, Unset):
        json_legacy = UNSET
    else:
        json_legacy = legacy
    params["legacy"] = json_legacy
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/workflows/{workflow_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        legacy (bool | None | Unset): Use the legacy workflow format. Default: False.
        version (int | None | Unset): The version of the workflow to fetch.
