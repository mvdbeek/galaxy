...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/api/invocations/{invocation_id}/steps/{step_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Update state of running workflow step invocation - still very nebulous but this would be for stuff
    like confirming paused steps can proceed etc.

    Args:
        invocation_id (str):  Example: 0123456789ABCDEF.
        step_id (str):  Example: 0123456789ABCDEF.
