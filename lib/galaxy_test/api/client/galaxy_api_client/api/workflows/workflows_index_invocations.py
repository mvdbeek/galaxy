...
def _get_kwargs(
    *,
    ...
    include_nested_invocations: bool | Unset = True,
    ...
    params["include_nested_invocations"] = include_nested_invocations
...
def sync_detailed(
    *,
    ...
    Args:
        workflow_id (None | str | Unset): Return only invocations for this Workflow ID
        ...
        include_nested_invocations (bool | Unset):  Default: True.
