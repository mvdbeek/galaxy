...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/invocations/{invocation_id}/request".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get a description modeling an API request to invoke this workflow - this is recreated and will be
    more specific in some ways than the initial creation request.
