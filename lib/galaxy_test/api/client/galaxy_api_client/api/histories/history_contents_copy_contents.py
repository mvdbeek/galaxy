...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/histories/{history_id}/copy_contents".format(
...
) -> CopyDatasetsResponse | MessageExceptionModel | None:
    if response.status_code == 200:
        response_200 = CopyDatasetsResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[CopyDatasetsResponse | MessageExceptionModel]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        CopyDatasetsResponse | MessageExceptionModel
    """
