...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/histories/{history_id}/contents/{type_}s/{id}/prepare_store_download".format(
...
) -> AsyncFile | MessageExceptionModel | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[AsyncFile | MessageExceptionModel]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        AsyncFile | MessageExceptionModel
    """
