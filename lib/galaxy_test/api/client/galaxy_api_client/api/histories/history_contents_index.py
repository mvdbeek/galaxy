...
from ...models.history_contents_index_accept import HistoryContentsIndexAccept
...
def _get_kwargs(
    ...
    *,
    ...
    accept: HistoryContentsIndexAccept | Unset = HistoryContentsIndexAccept.APPLICATIONJSON,
...
def sync_detailed(
    ...
    **Note**: Anonymous users are allowed to get their current history contents.
    ...
    Args:
        ...
        accept (HistoryContentsIndexAccept | Unset): Accept header to determine the response
            format. Default is 'application/json'. Default:
            HistoryContentsIndexAccept.APPLICATIONJSON.
