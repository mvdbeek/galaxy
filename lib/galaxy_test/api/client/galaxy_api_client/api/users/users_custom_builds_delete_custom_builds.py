...
) -> DeletedCustomBuild | MessageExceptionModel | None:
    if response.status_code == 200:
        response_200 = DeletedCustomBuild.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[DeletedCustomBuild | MessageExceptionModel]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        DeletedCustomBuild | MessageExceptionModel
    """
