            ...
            def _parse_response_200_item(
                ...
                try:
                    if not isinstance(data, dict):
                        raise TypeError()
                    response_200_item_type_0 = HDACustom.from_dict(data)
                ...
                try:
                    if not isinstance(data, dict):
                        raise TypeError()
                    response_200_item_type_1 = HDADetailed.from_dict(data)
                ...
                try:
                    if not isinstance(data, dict):
                        raise TypeError()
                    response_200_item_type_2 = HDASummary.from_dict(data)
                ...
                try:
                    if not isinstance(data, dict):
                        raise TypeError()
                    response_200_item_type_3 = HDAInaccessible.from_dict(data)
                ...
                try:
                    if not isinstance(data, dict):
                        raise TypeError()
                    response_200_item_type_4 = HDCACustom.from_dict(data)
                ...
                try:
                    if not isinstance(data, dict):
                        raise TypeError()
                    response_200_item_type_5 = HDCADetailed.from_dict(data)
                ...
                if not isinstance(data, dict):
                    raise TypeError()
                response_200_item_type_6 = HDCASummary.from_dict(data)
...
def sync_detailed(
    *,
    ...
    Args:
        history_id (None | str | Unset): Optional identifier of a History. Use it to restrict the
