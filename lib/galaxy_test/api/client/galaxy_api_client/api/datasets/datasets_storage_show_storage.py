...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/datasets/{dataset_id}/storage".format(
...
) -> DatasetStorageDetails | MessageExceptionModel | None:
    if response.status_code == 200:
        response_200 = DatasetStorageDetails.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[DatasetStorageDetails | MessageExceptionModel]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        DatasetStorageDetails | MessageExceptionModel
    """
