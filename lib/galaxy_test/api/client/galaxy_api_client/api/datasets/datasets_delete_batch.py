...
) -> DeleteDatasetBatchResult | MessageExceptionModel | None:
    if response.status_code == 200:
        response_200 = DeleteDatasetBatchResult.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[DeleteDatasetBatchResult | MessageExceptionModel]:
    return Response(
...
def sync(
    ...
    **Warning**: only the ownership of the datasets (and upload state for HDAs) is checked,
    ...
    Returns:
        DeleteDatasetBatchResult | MessageExceptionModel
    """
