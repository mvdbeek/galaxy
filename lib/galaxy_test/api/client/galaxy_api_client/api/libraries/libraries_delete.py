...
from ...models.delete_library_payload import DeleteLibraryPayload
...
def _get_kwargs(
    id: str,
    *,
    body: DeleteLibraryPayload | None | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": "/api/libraries/{id}".format(
            id=quote(str(id), safe=""),
        ),
        "params": params,
    }

    if isinstance(body, DeleteLibraryPayload):
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        undelete (bool | None | Unset): Whether to restore a deleted library.
        run_as (None | str | Unset): The user ID that will be used to effectively make this API
            call. Only admins and designated users can make API calls on behalf of other users.
        body (DeleteLibraryPayload | None | Unset):
