...
) -> MessageExceptionModel | NotificationStatusSummary | None:
    if response.status_code == 200:
        response_200 = NotificationStatusSummary.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[MessageExceptionModel | NotificationStatusSummary]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        MessageExceptionModel | NotificationStatusSummary
    """
