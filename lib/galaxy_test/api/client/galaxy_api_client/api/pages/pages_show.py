...
) -> MessageExceptionModel | PageDetails | None:
    if response.status_code == 200:
        response_200 = PageDetails.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[MessageExceptionModel | PageDetails]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        MessageExceptionModel | PageDetails
    """
