...
) -> GroupResponse | MessageExceptionModel | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GroupResponse | MessageExceptionModel]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (GroupUpdatePayload): Payload schema for updating a group.
...
def sync(
    ...
    *,
    ...
    Returns:
        GroupResponse | MessageExceptionModel
    """
