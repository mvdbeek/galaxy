...
from ...models.body_ai_agents_custom_tool_create_custom_tool import BodyAiAgentsCustomToolCreateCustomTool
...
def _get_kwargs(
    *,
    body: BodyAiAgentsCustomToolCreateCustomTool,
