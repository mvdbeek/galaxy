...
class GroupRolesClient:
    ...
    async def group_roles_roles_index_2_2(
        self,
        group_id: str,
        ...
        Args:
            ...
            run-as (Optional[GroupRolesRolesIndexParamRunAs])
        ...
        match response.status_code:
            case 200:
                return cast(GroupRoleListResponse, response.json())
            case _:
    ...
    async def group_roles_roles_delete_2_2(
        self,
        group_id: str,
        role_id: str,
        ...
        Args:
            ...
            run-as (Optional[GroupRolesRolesDeleteParamRunAs])
                                     : The user ID that will be used to effectively make this
                                       API call. Only admins and designated users can make API
                                       calls on behalf of other users.
        ...
        match response.status_code:
            case 200:
                return cast(GroupRoleResponse, response.json())
            case _:
                raise HTTPError(response=response, message="Unhandled status code", status_code=response.status_code)
        # All paths above should return or raise - this should never execute
        assert False, "Unexpected code path"  # pragma: no cover
    ...
    async def group_roles_roles_show_2_2(
        self,
        group_id: str,
        role_id: str,
        ...
        Args:
            group_id (str)           : The ID of the group.
            role_id (str)            : The ID of the role.
            run-as (Optional[GroupRolesRolesShowParamRunAs])
                                     : The user ID that will be used to effectively make this
                                       API call. Only admins and designated users can make API
                                       calls on behalf of other users.
    ...
    async def group_roles_roles_update_2_2(
        self,
        group_id: str,
        role_id: str,
        ...
        Args:
            group_id (str)           : The ID of the group.
            role_id (str)            : The ID of the role.
            run-as (Optional[GroupRolesRolesUpdateParamRunAs])
                                     : The user ID that will be used to effectively make this
                                       API call. Only admins and designated users can make API
                                       calls on behalf of other users.
