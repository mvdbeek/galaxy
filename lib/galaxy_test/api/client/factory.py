...
def create_client(
    ...
    Returns:
        An APIClient instance with tag-based sub-clients (e.g., client.histories, client.datasets)
    ...
    Example:
        ...
        >>> # Use async methods:
        >>> history = await client.histories.histories_create_2_2(form_data={"name": "Test"})
    """
