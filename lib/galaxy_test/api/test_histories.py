...
class ImportExportTests(BaseHistories):
    ...
    def test_import_export_failed_job(self):
        ...
        # Note: This assertion is expected to fail until issue #20450 is fixed.
        # The collection's job_state_summary should show error count of 1 for the failed job,
        # but after export/import the error state may not be preserved for collections.
