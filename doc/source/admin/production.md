...
The following configuration options control short-term storage behavior:
...
-   `short_term_storage_cleanup_interval`: How often cleanup runs in seconds (default: 3600, i.e., 1 hour)
